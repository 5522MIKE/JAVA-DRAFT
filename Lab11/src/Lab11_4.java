/*实现一个简单的“记事本”软件，能进行文本文件的打开、编辑、保存工作。

（提示:以第二题为基础，增加文件打开功能，使用JFileChooser控件）*/
...
public class Lab11_4 extends JFrame { // 创建类，继承Jframe类
	...
	public static void main(String[] args) { // 主方法
		Lab11_2 thisClass = new Lab11_2(); // 创建本类对象
